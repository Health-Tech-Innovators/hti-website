      ...
      <div className="relative">
        <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
          <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-48 lg:pt-40 xl:col-span-6">
            <div className="mx-auto max-w-lg lg:mx-0">
              ...
              <div className="mt-10 flex items-center gap-x-6 animate-fade-in">
                ...
                <a href={`${process.env.NEXT_PUBLIC_BASE_PATH}/about`} className="text-sm/6 font-semibold text-gray-900 transition-all duration-300 hover:translate-x-2">
          ...
          <div className="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:mr-0">
            <img
              alt=""
              src={`${process.env.NEXT_PUBLIC_BASE_PATH}/product/home.jpg`}
